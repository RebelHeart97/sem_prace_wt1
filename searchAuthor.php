...
table{background-color: white; border:3px solid grey; margin:auto; font-family: mujfont; border-spacing: 1px; font-size: 17px; overflow:scroll; margin-top:-15%; margin-left:46.3%;}
...
.h2{color:white; font-family: mujfont; text-align:center; font-size:19px; margin-top:2%; }
