...
<meta charset="utf-8" />
<title>Seznam knih | Hledání knihy</title>
<style>
...
table{background-color: white; border:3px solid grey; margin:auto; font-family: mujfont; border-spacing: 1px; font-size: 17px; overflow:scroll; margin-top:-15%; margin-left:30%;}
...
<?php
echo "<div class='h2'>"  ;
echo "<h2>Nalezené knihy podle zadaného kritéria</h2>"   ;
echo "</div>" ;
...
$query = $_GET['name']; 
    ...
    if(strlen($query) >= $min_length){ // if query length is more or equal minimum length then
        ...
        $q = "SELECT * FROM books,autori,genre WHERE (nazev LIKE '%".$query."%') AND books.id_knihy = autori.id_knihy AND books.zanr = genre.id_genre";
